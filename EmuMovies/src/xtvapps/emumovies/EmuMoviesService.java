...
public class EmuMoviesService {
	...
	public static String login(String user, String password, String productId) throws IOException, ParserException, EmuMoviesException {
		...
		if (success) {
			return SimpleXML.getAttribute(result, "Session");
		} else {
