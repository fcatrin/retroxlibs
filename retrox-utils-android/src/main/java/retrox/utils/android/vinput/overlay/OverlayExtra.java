...
import retrox.utils.android.vinput.KeyTranslator;
...
public class OverlayExtra {
	...
	private static final RectF mButtonRect = new RectF();
	...
	public static ExtraButton createMouseButton(String name, String key, int left, int margin, int h, int size) {
		...
		mouseButton.event = new VirtualEvent(isLeftButton? VirtualEvent.MouseButton.LEFT: VirtualEvent.MouseButton.RIGHT);
